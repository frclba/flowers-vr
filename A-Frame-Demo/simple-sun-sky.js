  ...
  init: function (data) {
    ...
    if (data.fogColor.toUpperCase() === 'NONE') {
      ...
      this.material = new THREE.ShaderMaterial({
        uniforms: {
          lightColor: {
            value: new THREE.Color(data.lightColor)
          },
          darkColor: {
            value: new THREE.Color(data.darkColor)
          },
          sunNormal: {
            value: sunPos.normalize()
          },
          sunColor: {
            value: new THREE.Color(data.sunColor)
          }
        },
      ...
      this.material = new THREE.ShaderMaterial({
        uniforms: {
          ...
          fogColor: {
            value: new THREE.Color(data.fogColor)
          }
        },
        vertexShader: this.vertexShader,
